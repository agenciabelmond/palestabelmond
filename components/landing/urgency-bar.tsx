...
return ( <div className="sticky top-0 z-50 border-b border-[#f2dea2]/60 bg-[#f2dea2] text-[#1b160d]"> <div className="mx-auto flex max-w-6xl items-center justify-between gap-2.5 px-2.5 py-2.5 sm:justify-center sm:gap-5 sm:px-4 sm:py-2">
<p
  className="
    text-left
    text-[0.65rem]
...
>
  <span
    ...
    "
  >
    Últimas vagas no 1º lote dísponível - Últimas chances
  </span>
</p>
    <a
      href="#inscricao"
